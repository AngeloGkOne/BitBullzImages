...
async function manageFiles(directory) {
  try {
    ...
    const filesToKeep = {
      Rare: ['1_BBTap_Rare.png', '3_BBTap_Rare.png', '5_BBTap_Rare.png', '7_BBTap_Rare.png'], // Keep these 4
      Epic: ['2_BBTap_Epic.png', '4_BBTap_Epic.png'], // Keep these 2
      Legendary: ['6_BBTap_Legendary.png'], // Keep this 1
    };
    ...
    // Step 1: Collect files to keep for Rare, Epic, Legendary
    ...
    for (const rarity in filesToKeep) {
      ...
      // Track the prefixes of the files we're keeping (for conflict resolution)
